...
class SQLiteStorage:
    ...
    def upsert_kev(self, record: KEVRecord) -> None:
        self._upsert("kev", "cve_id", record.cve_id, record)

    def list_kev(self) -> list[KEVRecord]:
        return self._list("kev", KEVRecord)

    def get_kev(self, cve_id: str) -> KEVRecord | None:
        return self._get("kev", "cve_id", cve_id, KEVRecord)
    ...
    def list_source_items(self) -> list[SourceItem]:
        return self._list("source_items", SourceItem)
